    ...
    <div className="kiosk-frame section" data-testid="passport-screen">
      <div className="container max-w-3xl">
        ...
        <div className="mt-4 p-4 bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-lg border border-yellow-200">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-semibold text-gray-800 mb-1">Ready to Shop?</h3>
              <p className="text-sm text-gray-600">Visit our complete collection and make your purchase</p>
            </div>
            <a 
