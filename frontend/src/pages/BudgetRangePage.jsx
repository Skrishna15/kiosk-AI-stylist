...
export default function BudgetRangePage({ onNext, onBack, initialValue }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900" data-testid="budget-range-page">
      <div className="container mx-auto px-8 py-16 max-w-4xl">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-neutral-600/30 bg-neutral-800/50 backdrop-blur-sm mb-4">
            ...
            <span className="text-xs font-medium tracking-[0.2em] text-neutral-300 uppercase">Step 3 of 4</span>
          </div>
